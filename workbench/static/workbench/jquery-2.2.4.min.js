...
!(function (a, b) {
  ...
  ;(n.fn = n.prototype =
    {
      ...
      pushStack(a) {
        let b = n.merge(this.constructor(), a)
          ...
          return g !== n && 9 === g.nodeType && g.documentElement
            ? ((n = g),
              ...
              (t =
                b || Z.test(o.contains)
                  ? function (a, b) {
                      let c = 9 === a.nodeType ? a.documentElement : a,
                        d = b && b.parentNode
                      return (
                        a === d ||
                        !(
      ...
      (d = fa.selectors =
        {
          ...
          filter: {
            TAG(a) {
              let b = a.replace(ba, ca).toLowerCase()
              return "*" === a
                ? function () {
                    return !0
                  }
  ...
  let cb = /^(?:input|select|textarea|button)$/i,
    db = /^(?:a|area)$/i
  n.fn.extend({
    prop(a, b) {
  ...
  let ib = /^(?:focusinfocus|focusoutblur)$/
  n.extend(n.event, {
    trigger(b, c, e, f) {
      let g,
        h,
    ...
    simulate(a, b, c) {
      let d = n.extend(new n.Event(), c, { type: a, isSimulated: !0 })
  ...
  ;(n.offset = {
    ...
    n.each({ Height: "height", Width: "width" }, (a, b) => {
      n.each({ padding: `inner${a}`, content: b, "": `outer${a}` }, (c, d) => {
        n.fn[d] = function (d, e) {
          let f = arguments.length && (c || "boolean" != typeof d),
