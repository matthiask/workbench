...
;+(function (a) {
  let b = a.fn.jquery.split(" ")[0].split(".")
  if (
    (b[0] < 2 && b[1] < 9) ||
    (1 == b[0] && 9 == b[1] && b[2] < 1) ||
    b[0] > 3
  ...
  +(function (a) {
    function b() {
      ...
      for (let c in b) if (void 0 !== a.style[c]) return { end: b[c] }
      return !1
    }
      ...
      (c.prototype.slide = function (b, d) {
        ...
        if ((this.$element.trigger(k), !k.isDefaultPrevented())) {
          if (
            ...
            let l = a(this.$indicators.children()[this.getItemIndex(f)])
            l && l.addClass("active")
          }
          let m = a.Event("slid.bs.carousel", {
            relatedTarget: j,
            direction: h,
          })
          return (
  ...
  +(function (a) {
    ...
    ;(d.VERSION = "3.3.7"),
      ...
      (d.prototype.dimension = function () {
        let a = this.$element.hasClass("width")
      ...
      (d.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            ...
            let f = a.Event("show.bs.collapse")
            if ((this.$element.trigger(f), !f.isDefaultPrevented())) {
              e &&
                e.length &&
                (c.call(e, "hide"), b || e.data("bs.collapse", null))
              let g = this.dimension()
              this.$element
              ...
              let i = a.camelCase(["scroll", g].join("-"))
              this.$element
      ...
      (d.prototype.hide = function () {
        if (!this.transitioning && this.$element.hasClass("in")) {
          let b = a.Event("hide.bs.collapse")
  ...
  +(function (a) {
    ...
    ;(c.VERSION = "3.3.7"),
      ...
      (c.prototype.show = function (b) {
        ...
        this.$element.trigger(e),
          this.isShown ||
            ...
            this.backdrop(() => {
              let e = a.support.transition && d.$element.hasClass("fade")
              d.$element.parent().length || d.$element.appendTo(d.$body),
                ...
                d.enforceFocus()
              let f = a.Event("shown.bs.modal", { relatedTarget: b })
              e
                ? d.$dialog
                    .one("bsTransitionEnd", () => {
      ...
      (c.prototype.setScrollbar = function () {
        let a = parseInt(this.$body.css("padding-right") || 0, 10)
  ...
  +(function (a) {
    ...
    ;(c.VERSION = "3.3.7"),
      ...
      (c.prototype.init = function (b, c, d) {
        ...
        for (let e = this.options.trigger.split(" "), f = e.length; f--; ) {
          ...
          if ("click" == g)
            ...
            let h = "hover" == g ? "mouseenter" : "focusin",
      ...
      (c.prototype.isInStateTrue = function () {
        for (let a in this.inState) if (this.inState[a]) return !0
        return !1
      }),
      ...
      (c.prototype.show = function () {
        let b = a.Event(`show.bs.${this.type}`)
        if (this.hasContent() && this.enabled) {
          ...
          let p = this.getCalculatedOffset(h, k, l, m)
      ...
      (c.prototype.applyPlacement = function (b, c) {
        ...
        let k = this.getViewportAdjustedDelta(c, b, i, j)
        k.left ? (b.left += k.left) : (b.top += k.top)
        let l = /top|bottom/.test(c),
      ...
      (c.prototype.getPosition = function (b) {
        ...
        let f = window.SVGElement && c instanceof window.SVGElement,
      ...
      (c.prototype.getViewportAdjustedDelta = function (a, b, c, d) {
        ...
        let f = (this.options.viewport && this.options.viewport.padding) || 0,
  ...
  +(function (a) {
    ...
    ;(b.VERSION = "3.3.7"),
      ...
      (b.prototype.activate = function (b) {
        ...
        let c = `${this.selector}[data-target="${b}"],${this.selector}[href="${b}"]`,
