...
class OffersTest(TestCase):
    ...
    def test_offer_with_closed_project(self):
        ...
        self.assertEqual(
            offer.status_badge,
            '<span class="badge text-bg-warning">Offered on 21.04.2020, but project closed on 21.04.2020</span>',
        )
    ...
    def test_offer_not_valid_anymore(self):
        ...
        self.assertEqual(
            offer.status_badge,
            '<span class="badge text-bg-warning">Offered on 04.02.2020, but not valid anymore</span>',
        )
